...
(* OASIS_START *)
(* DO NOT EDIT (digest: a5ca4a5ec4cea79af4079e3c907d9dbe) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_nat"; "Nat_shims"; "Nat_rewrite"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Nat_translations"; "Nat_decompose"];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\129Fh\139\182\179\158\203\199\187\145\154NX]\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
